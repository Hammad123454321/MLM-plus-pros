...
<body>
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<h3 class="title">Install Hmaza MLM</h3>
			</div>
		</div>
	</header>
						...
						<div class="box-item">
							...
							if ($action == 'result') {
								...
								if (@$response['error'] == 'ok') {
									...
									echo '<div class="warning mt-2"><h5 class="mb-4 fw-normal">You can ask for support by creating a support ticket.</h5><a href="callto:03469344735" target="_blank" class="theme-button choto">create  ticket</a></div>';
								}
								echo '</div>';
							...
							?>
								...
								<div class="item">
									<h5 class="subtitle font-weight-bold">Have a nice juorney</h5>
									<ul class="check-list">
										
									</ul>
									<span class="text-warning"><i class="fas fa-exclamation-triangle"></i> If any issue or error occurred call at 0346 9344735. </span>
								</div>
								<div class="item">
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="">domain</a></p>
		</div>
	</footer>
