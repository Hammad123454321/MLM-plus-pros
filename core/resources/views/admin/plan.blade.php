                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Status')">
                                @if($plan->status == 1)
                                    <span class="badge btn-success">@lang('Active')</span>
                                    @else
                            ...
                            <td data-label="@lang('Action')">
                                <button class="btn btn-outline-primary btn-sm planBtn" id data-id="{{ $plan->id }}" data-name="{{ $plan->name }}" data-price="{{ getAmount($plan->price) }}" data-daily_limit="{{ $plan->daily_limit }}" data-validity="{{ $plan->validity }}" data-status="{{ $plan->status }}" data-ref_level="{{ $plan->ref_level}}" data-act="Edit">
